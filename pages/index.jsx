...
export default function Home() {
	...
	const contractAddress = '0xC1b3B0d4A52eBa3D92b45Dc5Ae124B056f61Ea14';
	...
	const buyChai = async () => {
		try {
			...
			if (ethereum) {
				...
				const coffeeTxn = await buyMeAChai.buyChai(
					name ? name : 'anon',
	...
	return (
		<div className={styles.container}>
			<Head>
				<title>Buy us a Masala chai!!!</title>
			...
			<main className={styles.main}>
				...
				{currentAccount ? (
					<div>
						<form>
							<div>
								<label className={styles.nameinput}>Name</label>
								<br />
							...
							<div>
								<button className={styles.send} type="button" onClick={buyChai}>
									Send 1 Chai for 0.001ETH
								</button>
							</div>
						</form>
					</div>
			...
			{currentAccount && <h1 className={styles.messages}>Messages received</h1>}
